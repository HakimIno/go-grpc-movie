...
type movieServer struct {
	app *echo.Echo
	pb.UnimplementedMoviesappServer
}
...
func main() {
	...
	pb.RegisterMoviesappServer(s, &movieServer{})
...
func (s *movieServer) GetMovies(in *pb.Empty,
	stream pb.Moviesapp_GetMoviesServer) error {
...
func (s *movieServer) CreateMovies(ctx context.Context,
